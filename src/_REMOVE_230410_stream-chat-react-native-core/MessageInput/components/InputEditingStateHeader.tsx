...
>({
  ...
  return (
    <SafeAreaView style={[styles.editingBoxHeader, editingBoxHeader]}>
...
>(
  ...
  const { clearEditingState, resetInput } =
    useMessageInputContext<StreamChatGenerics>()

  return (
    <MemoizedInputEditingStateHeader
      {...{ clearEditingState, resetInput }}
      {...props}
    />
  )
