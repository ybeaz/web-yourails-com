...
> = Pick<
  ...
  'clearQuotedMessageState' | 'resetInput'
> &
...
>({
  ...
  return (
    <SafeAreaView style={[styles.replyBoxHeader, editingBoxHeader]}>
      <CurveLineLeftUp pathFill={grey_gainsboro} />
      <Text
        style={[
          styles.replyBoxHeaderTitle,
          { color: black },
...
>(
  ...
  const { clearQuotedMessageState, resetInput } =
    useMessageInputContext<StreamChatGenerics>()

  return (
    <MemoizedInputReplyStateHeader
      {...{ clearQuotedMessageState, resetInput }}
      {...props}
    />
  )
